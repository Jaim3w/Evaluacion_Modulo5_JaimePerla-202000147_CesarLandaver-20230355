...
import { auth, database } from '../config/firebase'; // Asegúrate que tu archivo de configuración exporte auth y database
...
const Register = ({ navigation }) => {
    ...
    // Función para navegar a la pantalla de Login (o la que prefieras)
    const goToLogin = () => {
    ...
    const registrarUsuario = async () => {
        ...
        // Validación simple para que los campos no estén vacíos
        ...
        try {
            ...
            // Se usará el UID del usuario como ID del documento para mantener la consistencia
